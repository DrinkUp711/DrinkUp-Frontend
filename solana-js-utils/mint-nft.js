...
const feePayer = Keypair.fromSecretKey(
  base58.decode("2QxoAcbpYWqSM4LeSuzFnS4mJKHdcqPD6Wq7NjyXkrCFx7hthxHVDqzasuYLF5poLKUVJR1CTZiYfVmFbFNt2ioM") // [payer account]
);
...
(async () => {
  ...
  let ata = await getAssociatedTokenAddress(mint.publicKey, feePayer.publicKey); // [ mint to account]
